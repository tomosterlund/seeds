const legalDiscLang = {
    english: {
        ...
        txt1: 'In order to offer you the best possible user experience at Seeds, we use cookies and store some data about your activity on the page.',
        btn: 'I accept the terms'
    },
    deutsch: {
